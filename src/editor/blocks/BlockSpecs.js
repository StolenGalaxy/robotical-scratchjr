...
export default class BlockSpecs {
    ...
    static setupPalettesDef() {
        ...
        ['minionsassemble', 'confusion', 'disbelief', 'excitement', 'noway', 'no', 'whistle', 'playnote'],
    ...
    static setupBlocksSpecs() {
        return {
            ...
            'minionsassemble' : ['minionsassemble', BlockSpecs.getImageFrom('assets/blockicons/minionsassemble', 'svg'),
    ...
    static blockDesc(b, spr) {
        ...
        return {
            ...
            'minionsassemble': Localization.localize('BLOCK_PLAY_MINIONSASSEMBLE_SOUND'),
