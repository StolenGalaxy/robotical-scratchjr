...
export default class Prims {
    ...
    static init() {
        ...
        Prims.table.minionsassemble = Prims.playMinionsassemble;
    ...
    static playMinionsassemble(strip){
        const durationInSeconds = 10;
        console.log("playing minions assemble");
        P3Blocks.getInstance().playSound("minionsassemble");
        Prims.setTime(strip);
